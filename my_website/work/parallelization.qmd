...
## Bonus - Parallelize package installs! 

Parallelize your package installs (particularly useful for monstrous bioconductor packages) using `pak` with `renv`. `pak` will natively use parallelization for the install, making it a ton faster. 
