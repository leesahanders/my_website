...
> For example, for a super-token you might have your admin generate keys for package manager via `rspm create token --scope=global:admin --expires=never` and share them via a 1password note. 
